<footer class="mod-footer" role="contentinfo" id="footer_in">
	<p class="f_bq">
		<?php if($word_t2!=""){echo $word_t2;}else{echo 'Copyright';} ?> &copy; 2014-<?php echo date("Y"); echo " <a class='banquan' title='";bloginfo('name');echo '：'; bloginfo('description');echo "' target='_blank' href='//covear.top/'>"; bloginfo('name'); echo '</a><a title="View Information" href="http://icp.chinaz.com/info?q=covear.top" target="_blank"> · </a><a href="http://beian.miit.gov.cn/" target="_blank">湘ICP备17019987号</a>'; ?></p>
</footer>
<script>
